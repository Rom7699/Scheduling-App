...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, password, existingUser, user, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, User_1.default.create({ name: name_1, email: email, password: password })];
            case 2:
                user = _b.sent();
    ...
    return __generator(this, function (_e) {
        res.status(200).json({
            ...
            user: {
                ...
                isAdmin: (_d = req.user) === null || _d === void 0 ? void 0 : _d.isAdmin
            }
        });
        return [2 /*return*/];
    });
