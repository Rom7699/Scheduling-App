    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mongoose_1.default.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/scheduling-app')];
            case 1:
                _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error('MongoDB connection error:', error_1.message);
